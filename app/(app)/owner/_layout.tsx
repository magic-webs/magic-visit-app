...
export default function OwnerLayout() {
  const result = useRequireRole("owner");
  ...
  return (
    <Stack screenOptions={{ headerShown: false }}>
      ...
      <Stack.Screen name="branches/new" options={{ presentation: "modal" }} />
      <Stack.Screen name="branches/[branchId]" options={{ presentation: "modal" }} />
